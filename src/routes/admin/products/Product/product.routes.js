...
const ProductController = require('../../../../controllers/admin/products/Product/ProductController');
const { authenticate, authorize, validate } = require('../../../../middleware');
const { createProductSchema, updateProductSchema, bulkProductSchema } = require('../../../../validators/admin/products/Product/product.validator');
